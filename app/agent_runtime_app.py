...
class AgentEngineApp(A2aAgent):
    ...
    def get_agent_card(self) -> dict:
        ...
        card_dict = {
            "name": getattr(root_agent, "name", "simple_form_agent"),
            "description": getattr(root_agent, "description", "Managed GEAP agent for rendering a contact form and saving details."),
            "version": "0.1.0",
            "tools": []
        }
